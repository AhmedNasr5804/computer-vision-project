...
to a contemporary front-camera deployment ($-34$\,pp on 44 captured
photos), and a 44-photo personal fine-tune closes the
deployment-side gap (44/44 correct) while keeping a usable
$0.764$ on the canonical CEW test split. PTQ-int8 conversion of
this fine-tuned model retains both accuracies and ships at
107\,KB.
